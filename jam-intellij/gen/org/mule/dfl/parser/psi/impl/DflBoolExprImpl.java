...
public class DflBoolExprImpl extends DflExpressionImpl implements DflBoolExpr {

  public DflBoolExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DflVisitor) ((DflVisitor)visitor).visitBoolExpr(this);
